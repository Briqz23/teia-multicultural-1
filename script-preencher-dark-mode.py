...
sair_button = ttk.Button(button_frame, text="SAIR", command=window.quit, style="danger.TButton")
sair_button.pack(side="left", padx=10)

criar_button = ttk.Button(button_frame, text="CRIAR", command=criar, style="success.TButton")
